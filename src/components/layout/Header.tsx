                ...
                <nav className="container mx-auto px-6 lg:px-12 xl:px-20 py-4 bg-black/40 backdrop-blur-2xl border-b border-orange-500/20">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            <Link 
                                href="/#collections" 
                                className="flex items-center gap-2 px-4 py-2 text-slate-300 hover:text-orange-400 hover:bg-white/10 rounded-xl transition-all duration-300 group"
                            >
                            ...
                            <Link 
                                href="/articles" 
                                className="flex items-center gap-2 px-4 py-2 text-slate-300 hover:text-purple-400 hover:bg-white/10 rounded-xl transition-all duration-300 group"
                            >
